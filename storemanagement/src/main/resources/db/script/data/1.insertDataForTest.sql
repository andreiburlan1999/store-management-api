-- Inserts for User (password: 123)
INSERT INTO "user" (id, username, password, role, name, email, address)
VALUES (seq_user.NEXTVAL, 'jdoe', '$2a$12$scLCnOYlT6Z/gR2GToNih.VFKPjyqEP9Hjilf41LCUDJdHvd3y0iu', 'ADMIN', 'John Doe', 'john.doe@example.com', '123 Street');

INSERT INTO "user" (id, username, password, role, name, email, address)
VALUES (seq_user.NEXTVAL, 'jsmith', '$2a$12$scLCnOYlT6Z/gR2GToNih.VFKPjyqEP9Hjilf41LCUDJdHvd3y0iu', 'CUSTOMER', 'Jane Smith', 'jane.smith@example.com', '456 Street');

INSERT INTO "user" (id, username, password, role, name, email, address)
VALUES (seq_user.NEXTVAL, 'ajohnson', '$2a$12$scLCnOYlT6Z/gR2GToNih.VFKPjyqEP9Hjilf41LCUDJdHvd3y0iu', 'CUSTOMER', 'Alice Johnson', 'alice.johnson@example.com', '789 Street');
